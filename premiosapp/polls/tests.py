...
class QuestionModelTest(TestCase):
    ...
    def test_was_published_recently_with_future_questions(self):
        ...
        future_question = Question(question_text="¿Quién es el mejor Course Director de Platszi?", pub_date=time)
        self.assertIs(future_question.was_published_recently(), False)

def create_question(question_text, days):
    """"
    Create a question with the given "question_text", and published the givben
    numbre of days offset to now (negative for questions published in the past,
